    ...
    private void Update()
    {
        ...
        if (spawningFinished == true && GameObject.FindGameObjectsWithTag("Enemy").Length == 0)
        {
            ...
            else
            {
                ...
                if (bossSpawned == true && GameObject.FindGameObjectsWithTag("Boss").Length == 0)
                {
                    Debug.Log("Voce Ganhou...n deu tempo de terminar '-'");
                }
                Debug.Log(GameObject.FindGameObjectsWithTag("Boss").Length);
            }
